...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_dataTable_t, stringdata) + ofs \
...
const QMetaObject dataTable::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_dataTable.data,
      qt_meta_data_dataTable,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_dataTable.stringdata))
        return static_cast<void*>(const_cast< dataTable*>(this));
